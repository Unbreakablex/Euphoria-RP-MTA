...
function vercamaritas(player)
	if exports.factions:isPlayerInFaction(player, 1) then
		if not isElementInRange(player,  231.2431640625, 76.4140625, 1005.0390625, 2) then outputChatBox("(( No estás en el ordenador policial ))", player, 255, 0, 0) return end
