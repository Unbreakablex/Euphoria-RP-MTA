...
function ventanaReformaInit()
    vConstruccion = guiCreateWindow(624, 348, 700, 306, "Sistema de Construcción y Reformas - Exotic - Juego de Rol", false)
    guiWindowSetSizable(vConstruccion, false)

    lInfoConstr = guiCreateLabel(24, 39, 629, 21, "Bienvenido al sistema de Construcción y Reformas de EX:RP, por favor selecciona una opción.", false, vConstruccion)
