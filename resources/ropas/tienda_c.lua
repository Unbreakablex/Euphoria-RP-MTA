...
function newSkinGui()
	window[1] = guiCreateWindow(0.01,0.4,0.35,0.6,"Sistema de Ropas - Exotic - Juego de Rol.",true)
			...
			if row and col and row ~= -1 and col ~= -1 then
				...
				if getElementModel(getLocalPlayer()) == 0 then
					...
					if tipo == 18 then -- Skin antigua, le asignamos skin CJ
						...
						outputChatBox("Se ha producido un error. Contacta con Unbreaking.", 255, 0, 0)
					end
				end 
			else
