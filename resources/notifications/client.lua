...
local details = {
    ["warning"] = {"Advertencia", "warning", "w.mp3"},
    ["error"] = {"Error", "error", "error.wav"},
    ["info"] = {"Información", "information", "i.mp3"},
    ["mod"] = {"", "information", "i.mp3"},
    ["models"] = {"", "information", "i.mp3"},
    ["success"] = {"Exitó", "success", "s.mp3"},
    ["admin"] = {"", "adminduty", "s.mp3"},
}
...
function getColors(render)
    ...
    if enabled then
        ...
        types = {
            ...
            ["admin"] = {"", {engine:getServerColor('lightyellow', false)}},
        }
    end
end
