...
function trabajosUsuario(player, cmd, trabaj)
	if exports.players:isLoggedIn(player) then 
		if not trabaj then
			outputChatBox("Lista de trabajos temporales.", player, 255, 255, 0)
			outputChatBox("Limpiador: Súbete a un Sweeper y limpia las calles.", player, 255, 255, 255)
			outputChatBox(" ", player, 255, 255, 255)
			outputChatBox("Basurero: Súbete a un Trashmaster y recoge la basura del condado.", player, 255, 255, 255)
			outputChatBox(" ", player, 255, 255, 255)
			...
			outputChatBox(" ", player, 255, 255, 255)
			outputChatBox("Butanero: Súbete a una Rumpo y entrega el butano.", player, 255, 255, 255)
		else
			local trabajo = string.lower(tostring(trabaj))
			if tostring(trabajo) == "limpiador" then
				x, y, z = 1349.62, 350.19, 20.1
			elseif tostring(trabajo) == "basurero" then
				x, y, z = 1349.62, 350.19, 20.1
			...
			elseif tostring(trabajo) == "butanero" then
				x, y, z = 1224.10, 162.57, 20.61
			else
				outputChatBox("Trabajo no válido. Usa /trabajos para verlos y /trabajos [nombre] (ej: /trabajos limpiador)", player, 255, 255, 0)
				return
			end
			createBlip( x, y, z, 0, 2, 0, 0, 255, 255, 0, 99999.0, player )
			outputChatBox("Se ha marcado el trabajo solicitado. ¡Buena suerte "..getPlayerName(player):gsub("_", " ").."!", player, 0, 255, 0)
		end
	end
end
