barreraP1PCMG = createObject ( 968, 2068.17, 41.7, 26.18, 0, 90, 88 )
	...
	if getElementData(player, "peajePagado1") then
		...
		if exports.players:takeMoney(player, 5) then
			...
			if esBarP1PCMG == 0 then
				...
				moveObject ( barreraP1PCMG, 1200, 2068.17, 41.7, 26.18, 0, -90, 0)
				esBarP1PCMG = 4
				setTimer( function ()
			...
			elseif esBarP1PCMG == 2 then
				...
				local diff = -ry
				exports.chat:me( player, "paga el peaje y le abren la barrera." )
				moveObject ( barreraP1PCMG, 1200, 2068.17, 41.7, 26.18, 0, diff, 0)
				esBarP1PCMG = 3
				setTimer( function ()
				esBarP1PCMG = 1 end, 1200, 1 )
			end
...
barreraP2PCMG = createObject ( 968, 2068.17, 41.7, 26.12, 0, 270, 87.995 )
	...
	if getElementData(player, "peajePagado2") then
		...
		if exports.players:takeMoney(player, 5) then
			...
			if esBarP2PCMG == 0 then
				...
				exports.chat:me( player, "paga el peaje y le abren la barrera." )
				moveObject ( barreraP2PCMG, 1200, 2068.17, 41.7, 26.12, 0, 90, 0)
				esBarP2PCMG = 4
				setTimer( function ()
			...
			elseif esBarP2PCMG == 2 then
				...
				local diff = 360-ry
				exports.chat:me( player, "paga el peaje y le abren la barrera." )
				moveObject ( barreraP2PCMG, 1200, 2068.17, 41.7, 26.12, 0, diff, 0)
				esBarP2PCMG = 3
				setTimer( function ()
				esBarP2PCMG = 1 end, 1200, 1 )
			end
