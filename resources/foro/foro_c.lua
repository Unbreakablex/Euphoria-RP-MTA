...
function openWindowLinkForum()
	...
	vGestForo = guiCreateWindow(x*541/1600, y*243/900, x*463/1600, y*405/900, "Vinculación de cuenta con foro - Exotic - Juego de Rol", false)
	guiWindowSetSizable(vGestForo, false)

	lInfo = guiCreateLabel(x*24/1600, 36, x*414/1600, y*151/900, "Para poder disfrutar de todos los servicios EX:RP, es necesario que dispongas de una cuenta de foro y, además, que esta cuenta esté vinculada a tu cuenta IG.\n\nSi ya tienes cuenta de foro, introduce tus datos abajo para vincularla a tu cuenta.\n\nSi no tienes cuenta, rellena el formulario del mismo modo y haz click en 'Vincular'. Te crearemos una y te la vincularemos.", false, vGestForo)
