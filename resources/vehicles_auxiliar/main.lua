...
function localizarVehiculo ( player, commandName, vehID )
		if not isElementInRange(player, 252.390625, 117.4404296875, 1003.21875, 10) then outputChatBox("Acude a comisaría justo en la Info de la entrada usa este comando.", player, 255, 0, 0) return end
	...
	if exports.players:isLoggedIn(player)then
		...
		if not vehID then 
			...
			outputChatBox("Usa tu telefono para ver las ID de tus autos.", player, 255, 255, 255)
		else
			...
			setTimer(function() destroyElement(blipLocalizado[vehicle]) end, 300000, 1)
		end
	end
end
...
local markerDeposito = createMarker(2422.62, 48.8, 25.7, "cylinder", 2, 102, 204, 255, 0)
