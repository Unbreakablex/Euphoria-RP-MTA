...
function showCondiciones(version, texto)
        ...
        ventana = guiCreateWindow(0.31, 0.18, 0.37, 0.70, "Condiciones del servicio. Exotic - Juego de Rol. Versión "..tostring(version), true)
...
function editarCondiciones(version, texto)
        ...
        toggleAllControls(false) 
	    setElementData(getLocalPlayer(), "nogui", true )
        ventana2 = guiCreateWindow(0.31, 0.18, 0.37, 0.70, "Condiciones del servicio. Exotic - Juego de Rol. Versión "..tostring(version), true)
