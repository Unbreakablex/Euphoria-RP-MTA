...
function todo(player)
	...
	outputChatBox("Has aceptado las condiciones de uso de Exotic - Juego de Rol. ¡Disfruta del servidor!", player, 0, 255, 0)
...
outputChatBox("Has rechazado las condiciones. Ve a discord.gg/dm74JqHP8k para pedir borrar tu cuenta.", player, 255, 0, 0)
