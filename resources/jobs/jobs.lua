function conseguirEmpleo (job)
	...
	if exports.players:setJob(source, job) then
		if job == "limpieza" then
			...
			outputChatBox("Ricardo Edmundo le entrega las llaves del vehículo a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] Ricardo Edmundo dice: ¿Cómo dices? Si ya trabajas aquí...", source, 230, 230, 230 )
			outputChatBox("Ricardo Edmundo suspira", source, 255, 15, 215)
			end
		elseif job == "pescador" then
			...
			outputChatBox("John Pescanova le entrega las llaves del barco a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] John Pescanova dice: ¿Cómo dices? Si ya trabajas aquí...", source, 255, 15, 215 )
		...
		elseif job == "repartidor" then
			...
			outputChatBox("Pedro Hidalgo le entrega las llaves del vehículo a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] Pedro Hidalgo dice: ¿Qué dices, tronco? Si ya trabajas aquí...", source, 230, 230, 230 )
			outputChatBox("Pedro Hidalgo suspira", source, 255, 15, 215)
			end
		elseif job == "conductor" then
			...
			outputChatBox("Antonio Kelvin le entrega las llaves del vehículo a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] Antonio Kelvin dice: ¿Cómo dices? Si ya trabajas aquí...", source, 230, 230, 230 )
			outputChatBox("Antonio Kelvin suspira", source, 255, 15, 215)
		   end
		elseif job == "butanero" then
			...
			outputChatBox("Daniel Martinez le entrega las llaves del vehículo a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] Daniel Martinez dice: ¿Cómo dices? Si ya trabajas aquí...", source, 230, 230, 230 )
			outputChatBox("Daniel Martinez suspira", source, 255, 15, 215)
			end
	   elseif job == "trailero" then
			if job ~= actualjob then
			outputChatBox("[English] Ander Blackwell dice: Enhorabuena. Ya puedes salir a trabajar.", source, 230, 230, 230 )
			outputChatBox("Ander Blackwell le entrega las llaves del vehículo a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] Ander Blackwell dice: ¿Cómo dices? Si ya trabajas aquí...", source, 230, 230, 230 )
			outputChatBox("Ander Blackwell suspira", source, 255, 15, 215)
		   end
		elseif job == "basurero" then
			...
			outputChatBox("Tino Svenson le entrega las llaves del vehículo a "..getPlayerName(source):gsub("_", " "), source, 255, 15, 215)
			else
			outputChatBox("[English] Tino Svenson dice: ¿Cómo dices? Si ya trabajas aquí...", source, 230, 230, 230 )
			outputChatBox("Tino Svenson suspira", source, 255, 15, 215)
		   end
		end
	end
end
