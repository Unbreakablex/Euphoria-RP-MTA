...
addEventHandler( "onPlayerQuit", root,
	...
	if reason == "Test fallido, visita exotic-rp.foroactivo.com y conéctate para inténtarlo..." then return end
	if type == "Kicked" then
		...
		if exports.players:isLoggedIn( player ) then
			...
			for key, value in ipairs( getElementsByType( "player" ) ) do
				...
				if groups and #groups >= 1 then
					...
					if title and title ~= "VIP" and title ~= "Encubierto" and not getElementData(value, "enc") and exports.players:isLoggedIn(value) then
