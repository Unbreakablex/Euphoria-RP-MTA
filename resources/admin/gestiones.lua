...
function borrarMiPJ(player, cmd, con)
	...
	outputChatBox("¿De verdad crees que íbamos a permitir que exista este comando?", player, 255, 255, 255)
	outputChatBox("Hay que estar muy loco para permitir una cosa como esta.", player, 255, 255, 255)
	outputChatBox("Contacta con UNBREAKING si quieres cambiarte el nombre.", player, 255, 255, 255)
	outputChatBox("Borrar un personaje no está permitido.", player, 255, 255, 255)
	outputChatBox("Jajajajaja "..getPlayerName(player):gsub("_", " ").." Intento borrar su pj. Que Napa", players, 255, 255, 255)
end
