dudauto = {
	{pregunta = "foro", respuesta = "La dirección de nuestro foro es exotic-rp.foroactivo.com"},
	{pregunta = "discord", respuesta = "La dirección de nuestro Discord es discord.gg/dm74JqHP8k"},
	{pregunta = "ds", respuesta = "La dirección de nuestro Discord es discord.gg/dm74JqHP8k"},
	...
	{pregunta = "trabajo", respuesta = "Usa /trabajos y si quieres uno mejor acude al discord discord.gg/dm74JqHP8k"},
}
...
function reportarUsuario (player, cmd, otherPlayer, ...)
	...
	outputChatBox("Este comando es solo para reportar bug o problemas con el servidor, en caso de ser un problema con otro usuario toma SS y reporta via foro.", player, 250, 0, 0)
end
addCommandHandler("re", reportarUsuario)
		...
		if ... and other then
			...
			if getElementData(other, "laduda") then
				...
				if other == thePlayer then
					banPlayer(thePlayer, true, true, true, "AntiAbuso EX:RP", "Seteo de Dudas Resueltas", 0)
				end
