...
addEventHandler("abrirconceaereo", root, 
	function(isvp)
		...
		vehTest = Vehicle(getVehicleModelFromName(tabVeh[indexV].m), 1366.83203125, 476.2607421875, 20.309841156006 )
		vehTest.dimension = 0
		setElementFrozen(vehTest, 1000)
		setCameraMatrix( 1352.107421875, 472.50390625, 23.287950515747, 1366.83203125, 476.2607421875, 20.309841156006, 0, 70 )
