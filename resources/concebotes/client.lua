...
addEventHandler("abrirconcebotes", root, 
	function(isvp)
		...
		vehTest = Vehicle(getVehicleModelFromName(tabVeh[indexV].m), 33.709178924561, 183.91659545898, 1.200643658638 )
		vehTest.dimension = 0
		setElementFrozen(vehTest, 1000)
		setCameraMatrix( 46.726566314697, 188.9873046875, 5.4984374046326, 33.709178924561, 183.91659545898, 1.200643658638, 0, 70 )
