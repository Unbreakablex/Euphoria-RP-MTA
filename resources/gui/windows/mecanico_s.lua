...
function bindGeneral(player)
	if exports.factions:isPlayerInFaction(player, 3) then
    	if exports.factions:isPlayerInFaction(player, 3) and not isElementInRange(player, 2124.0712890625, -2073.5009765625, 13.250932693481, 20) then outputChatBox("(( No estás en el taller. ))", player, 255, 0, 0) return end
...
function comprarPiezas(player, cmd, cantida)
	if exports.factions:isPlayerInFaction(player, 3) then
		...
		if exports.factions:isPlayerInFaction(player, 3) and not isElementInRange(player, 1491.455078125, 1306.2197265625, 1093.2963867188, 5) then outputChatBox("(( No estás en el taller. ))", player, 255, 0, 0) return end
