...
windows.login =
{
	...
	{
		type = "label",
		text = "Necesitas una cuenta para jugar en Exotic - Juego de Rol\nSi tienes una cuenta, incia sesión.",
		alignX = "center",
	},
	{
		type = "label",
...
function createlicenseTestIntroWindow()	
	...
	guiIntroLabel1 = guiCreateLabel(0, 0.3,1, 0.5, [[Vas a realizar el test de rol de Exotic - Juego de Rol.
