...
windows.login =
{
	...
	{
		type = "label",
		text = "Necesitas una cuenta para jugar en Euphoria - Juego de Rol\nSi tienes una cuenta, incia sesión.",
		alignX = "center",
	},
	{
		type = "label",
...
function createlicenseTestIntroWindow()	
	...
	guiIntroWindow = guiCreateWindow ( X , Y , Width , Height , "Test de rol. Exotic - Juego de Rol." , false )
	
	guiCreateStaticImage (0.35, 0.1, 0.3, 0.2, "banner.png", true, guiIntroWindow)
	
	guiIntroLabel1 = guiCreateLabel(0, 0.3,1, 0.5, [[Vas a realizar el test de rol de Euphoria - Juego de Rol.
	Son 20 preguntas tipo test, pudiendo fallar 2. Te recomendamos ir a https://discord.gg/dm74JqHP8k]], true, guiIntroWindow)	
