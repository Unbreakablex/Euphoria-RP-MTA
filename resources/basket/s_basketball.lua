...
function resourceStart(source)
   makeBasket(2278.3999023438, 26.60000038147) -- Cancha 1 Baloncesto 
   makeBasket(2260.6999511719, 26.5) -- Cancha 2 Baloncesto
   setTimer(newBallPls, 5000, 1)
end
addEventHandler("onResourceStart",getResourceRootElement(getThisResource()),resourceStart)

function newBallPls()
	newBall(2269.474609375, 26.439453125, 26) -- Pelota Fort Carson
end
