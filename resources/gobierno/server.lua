...
addCommandHandler("facciones", getFactions)
...
function electricidadfc(player)
	if exports.factions:isFactionOwner(player, 5) then
		if electricidadFC == 0 then
			...
			outputChatBox( "[Anuncio RCFM]: La planta eléctrica ha ordenado el encendido del tendido eléctrico.", root, 106, 255, 255 )
		...
		elseif electricidadFC == 1 then
			...
			outputChatBox( "[Anuncio RCFM]: La planta eléctrica ha ordenado el apagado del tendido eléctrico.", root, 106, 255, 255 )
